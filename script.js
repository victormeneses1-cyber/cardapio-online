...
function voltarInicio() {
    document.getElementById("menu").innerHTML = ""; document.getElementById("inicio").style.display = "block"
}
...
function verProfessor(index) {
    ...
    let menu = document.getElementById("menu")
    menu.innerHTML = `<button onclick="abrirAulas()" class="btn-voltar">⬅ Voltar</button><h2>${prof.nome}</h2><p>${prof.habilidades}</p><div class="menu" id="gridAulas"></div>`
